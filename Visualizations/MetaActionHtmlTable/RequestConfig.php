...
namespace Piwik\Plugins\MetaActionReport\Visualizations\MetaActionHtmlTable;
...
/**
 * DataTable Visualization that derives from RetailHtmlTable and sets show_extra_columns to true.
 */
