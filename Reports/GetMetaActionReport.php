 ...
 */
class GetMetaActionReport extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('MetaActionReport_MetaActionReport');
        $this->dimension     = null;
        ...
        $this->subcategoryId = 'MetaActionReport_MetaActionReport';
    }
    ...
    {
        $view = new View('@MetaActionReport/getMetaActionReport');
        $view->myData = array();
